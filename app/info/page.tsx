      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="about" className="mb-16 scroll-mt-16">
          ...
          <div className="prose prose-lg max-w-none">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">What is Coba T-shirts?</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">How does print-on-demand work?</h3>
            <p className="text-gray-600 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">What are the benefits of print-on-demand?</h3>
            <p className="text-gray-600 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">What printing methods do you use?</h3>
        ...
        <section id="returns" className="mb-16 scroll-mt-16">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-sm text-gray-500 mb-6">Last updated July 15, 2023</p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Exceptions</h3>
            <p className="text-gray-600 mb-4">
              For defective or damaged products, please contact us at the contact details below to arrange a refund or exchange.
            </p>

            <h4 className="text-lg font-semibold text-gray-800 mb-4">Please Note</h4>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
            ...
            <p className="text-gray-600">
              ...
              <a href="tel:+251938613544" className="text-blue-600 hover:text-blue-800">+251938613544</a> or{' '}
              <a href="mailto:customersupport@cobatshirts.com" className="text-blue-600 hover:text-blue-800">customersupport@cobatshirts.com</a>
            </p>
          </div>
        </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+251938613544" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
                      +251 938 61 35 44
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:customersupport@cobatshirts.com" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black/20 focus:border-black/20 transition-colors duration-200"
                ...
                <button
                  type="submit"
                  className="w-full bg-black text-white py-3 px-6 rounded-md hover:bg-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-black/20"
                >
                  Send Message
                </button>
              </form>
